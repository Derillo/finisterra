...
public class GameScreen extends ScreenAdapter implements WorldScreen {
    ...
    public GameScreen(AOGame game) {
        ...
        initWorldConfiguration(game.getAssetManager(), game.getClientConfiguration());
        initWorld(game);
    ...
    public void initWorld(AOGame game) {
        worldConfigBuilder.with(HIGH,
                new ClientResponseProcessor(game),
                new GameNotificationProcessor(game),
                game.getClientSystem(),
                new TimeSync());
